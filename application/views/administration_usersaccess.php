...
<div class="reg-form-holder">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="license-title">Administration Access</h1>
                <table>
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>User</th>
                        <th>Email</th>
                        <th>Administration Access</th>
                        <th>Date Created</th>
                        <th>Enable/Disable Administrative Access</th>
                    </tr>
                    </thead>
                    ...
                    foreach($results as $data) {
                        $setting=($data->administration)? 'True':'False';
                        ...
                        echo ' <td>';
                        echo  form_open('administration/EnaDisableAccess',array('name' => 'form_delete','class'=> ''),'');
                        echo  form_button(
                                array(
                                    'name'          => 'button_submit',
                                    'value'         => $data->id.' '.$data->administration,
                                    'type'          => 'submit',
                                    'class'          => 'btn-sign',
                                    'content'       => ($data->administration)? 'Disable':'Enable'
                                )
                        );
                        echo  form_close();
                        echo '</td>';
