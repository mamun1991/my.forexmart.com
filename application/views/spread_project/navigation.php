<?php  $this->load->view('partnership/partnership_nav.php') ?>




<div class="section rebate-system-container">
    <h1>Spread Project</h1>

    <p>Create your own spread project and increase your affiliate commission. You can set up bigger spreads for your referrals, so your affiliate commission will be increased accordingly. Create default project and individual projects. One link can be used for one project.</p>

    <div class="acct-tab-holder">
        <ul role="tablist" class="main-tab">
            <li class="part-li <?= $nav=='default'?'active':""?>" role="presentation"><a href="<?= FXPP::loc_url('spread-projects');?>"  <?= $nav=='default'?'class="gray-menu"':'class="gray-menu2"'?> ><i class="fa fa-check-circle"></i> Default</a></li>
            <li class="part-li <?= $nav=='personal_rebate'?'active':""?>" role="presentation"><a href="<?= FXPP::loc_url('spread-projects/individual-project');?>"  <?= $nav=='personal_rebate'?'class="gray-menu"':'class="gray-menu2"'?>><i class="fa fa-user"></i>  Individual project</a></li>
...
<style>
    /*----- ADDITIONAL STYLES -----*/
    .gray-menu{background: #C0C0C0!important}
    .gray-menu2{background: #EEE!important;}
    .partners-input {
