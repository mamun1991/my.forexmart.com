    ...
    <div class="error-content-holder">
        <div class="error-content-holder">
            ...
            <p class="error-cont-text">
                ...
                <span>ForexMart Smart Dollars</span> is under maintenance. We are working to improve the stability and upgrade the mechanics.<br> The service will be available as soon as the new update is completed.
            </p>
        </div>
    </div>
