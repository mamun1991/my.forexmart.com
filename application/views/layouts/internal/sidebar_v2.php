...
<div class="col-lg-3 col-md-3 col-sm-12 int-side-nav arabic-side-navigation arabic-hidden-section-title side-border" style="margin-top:10px;">
    ...
    <?php if ($this->session->userdata('login_type') != 1) { ?>
        ...
        <!--<div class="side-fix-holder">-->
           ...
           <!-- <div id="chance" class="chance-bonus-holder">
                <a href="#" data-toggle="modal" data-target="#chancemodal" id="clickchance">
                    <?php if(FXPP::html_url()=='ru'){?>
                        <?php if ($base_currency == 'EUR') { ?>
                            <img src="<?//= $this->template->Images() ?>chance-bonus-teaser-eur-russian.jpg" class="img-responsive">
                        <?php } else { ?>
                            <img src="<?//= $this->template->Images() ?>chance-bonus-teaser-russian.jpg" class="img-responsive">
                        <?php }
                    }else { ?>
                        <?php if ($base_currency == 'EUR') { ?>
                            <img src="<?//= $this->template->Images() ?>chance-eur.jpg" class="img-responsive">
                        <?php } else { ?>
                            <img src="<?//= $this->template->Images() ?>chance-usd.jpg" class="img-responsive">
                        <?php }
                    }?>
                </a>
            </div>-->
            ...
            <!--<ul class="side-fix">
                <li>
                    <a href="#" class="a-flast-child">
                        <?php if($base_currency == 'EUR'){ ?>
                            <p class="fix-lbl"><?=lang('sb_ch_mod_eur_li')?></p>
                        <?php }else{ ?>
                            <p class="fix-lbl"><?=lang('sb_ch_mod_usd_li2')?></p>
                        <?php } ?>
                    </a>
                </li>
            </ul>-->
           ...
           <!-- <ul class="side-fix-landscape">
                <li>
                    <?php if(FXPP::html_url()=='ru'){?>
                        <?php if ($base_currency == 'EUR') { ?>
                            <a href="#" class="ls-img3-eur-russian">
                            </a>
                        <?php } else { ?>
                            <a href="#" class="ls-img3-usd-russian">
                            </a>
                        <?php }
                    }else { ?>
                        <?php if ($base_currency == 'EUR') { ?>
                            <a href="#" class="ls-img3-eur">
                            </a>
                        <?php } else { ?>
                            <a href="#" class="ls-img3">
                            </a>
                        <?php }}?>
                </li>
            </ul>-->
    ...
    <?php }?>
            ...
            <?php if(FXPP::check_accountstatus()==false){ echo FXPP::check_accountstatus(); ?>
                <a href="<?= FXPP::loc_url($this->config->item('VerifyAccount'));?>"><button class="btnTemp-verify"><?=lang('sb_a_0');?></button></a>
            <?php }else{ ?>
                <button class="btnTemp-verified"><i class="fa fa-check-square-o fa-lg"></i><?=lang('veri_acc');?></button>
            <?php } ?>
            </div>
    ...
    <div class="dl-holder arabic-dl-holder">
        ...
        <div class="side-nav-holder">
            <ul class="side-nav2 side-nav arabic-side-nav" role="tablist">
                <li role="presentation" ><a id="s2" href="<?= FXPP::loc_url('profile/edit');?>" class=" <?=' bw '; ?><?=($active_tab == 'profile') ? 'active-sidenav' : '';?>"><i class="fa fa-user"></i><cite>
                            <?=lang('sb_li_1');?>
                        </cite></a></li>

                <li role="presentation" >
                    <a id="s1" href="<?= FXPP::loc_url('my-account');?>" class=" <?=' bw '; ?><?=($active_tab == 'accounts') ? 'active-sidenav' : '';?>" ><i class="fa fa-suitcase"></i><cite>
                            <?=lang('sb_li_0');?>
                        </cite></a>
                </li>
                ...
                <?php if(!FXPP::isAccountFromEUCountry()) {
                     ...
                     if($mt_set_id == 1 || $mt_set_id == 2 || $mt_set_id == 5  ){?>
                            <?php if ($this->session->userdata('login_type') != 1) { ?>
                                <li role="presentation">
 ...
 * */?>
            ...
            if(IPLoc::frz() and 1==4)
            {
                $status_data=FXPP::getAccountStatus();
              ...
              ?>
               ...
               <?php 
                 ...
                 ?>
                        <div class="btn-verified"> <button class="verified verified-custom" ><i class="fa fa-check-square-o fa-lg"></i><?=ucfirst($status_data['status_text'])?></button></div>
        
                     <?php }else{
                    
                       ?>
                        
                        <div class="btn-verified"> <a href="<?= FXPP::loc_url('profile/upload-documents');?>"> <button class="verified verified-custom" style="background:<?=($status_data['status_id']==0)?'gray;':'red'?>" ><?=ucfirst($status_data['status_text'])?></button> </a> </div>       
                 ...
                 <?php 
                     if($status_data['status_id']==1){
                 ?>
                    <div class="btn-verified"> <a href="<?= FXPP::loc_url('profile/upload-documents');?>"> <button class="verified verified-custom" ><?=ucfirst($status_data['status_move_text'])?></button> </a> </div>
            ...
            <?php }else{
                ...
                if(FXPP::check_accountstatus()==false){
                    ?>




                            <div class="btn-verify-holder" id="va">
                                <a href="<?= FXPP::loc_url($this->config->item('VerifyAccount'));?>" class="btn-verify cp">
                                    <?=lang('sb_a_0');?>
                                </a>
                            </div>
                ...
                <?php }else{?> 
                        ...
                        <button class="verified verified-custom" ><i class="fa fa-check-square-o fa-lg"></i><?=lang('veri_acc');?></button>
                        </div>
...
<!--            <button class="btn-withdraw">Withdraw Funds</button>-->
    ...
    <?php } ?>
        ...
        <?php } }?>
            ...
            <div class="chat-widget-container chat-hide" style="display:none;">
