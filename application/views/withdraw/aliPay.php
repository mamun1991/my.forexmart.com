        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title"><?= lang('alipay-opt-01') ?></h4>
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawAlipay')) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                   <input type="text" name="aliPay_account" class="form-control round-0 numeric" id="aliPay_account" placeholder="" value="<?php echo $cup_details['bank_account_number'] ?>"<?php echo $disabled ?>>
                            </div>
                            <div class="reqs col-sm-3">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnAlipayContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?> > <?= lang('with-p-05') ?> </a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                <div class="col-md-11 col-centered tab-pane" id="bt-tab2">
                    ...
                    <form class="form-horizontal reg-frm">
                        <div class="alert alert-info" role-alert>
                            <i class="fa fa-info-circle"></i><?= lang('alipay-opt-03') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <a id="btnAlipayBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" style="margin-right: 10px;"> <?=lang('wn_12');?> </a>
                                <a id="btnAlipaySendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?=lang('wn_13');?> </a>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-centered">
                                    ...
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/Alipay')?>" class="create-another"><?= lang('with-p-16') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
