        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title">Withdraw via ZotaPay <?= $currency; ?></h4>
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawZP')) ?>
                    ...
                    <?php } ?>
                    <input type="hidden" value="<?= $currency ?>" name="wallet_currency">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="bank_account_name" class="col-sm-4 cup-label-acc control-label contest-label"> <?= lang('with_04') ?> <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="bank_account_name" class="form-control round-0" id="bank_account_name" placeholder="" value="<?php echo $cup_details['bank_account_name'] ?>"<?php echo $disabled ?>>
                    ...
                    <div class="form-group">
                        <label for="bank_account_number" class="col-sm-4 cup-label-acc control-label contest-label"><?= lang('with_01') ?> <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="bank_account_number" class="form-control round-0 numeric" id="bank_account_number" placeholder="" value="<?php echo $cup_details['bank_account_number'] ?>"<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="bank_name" class="form-control round-0" id="bank_name" placeholder="" value="<?php echo $cup_details['bank_name'] ?>"<?php echo $disabled ?>>
                    ...
                    <div class="form-group">
                        <label for="bank_branch" class="col-sm-4 cup-label-acc control-label contest-label"> <?= lang('with_02') ?>  <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="bank_branch" class="form-control round-0" id="bank_branch" placeholder="" value="<?php echo $cup_details['branch'] ?>"<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bank_province" class="col-sm-4 cup-label-acc control-label contest-label">  <?= lang('with_06') ?> <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="bank_province" class="form-control round-0" id="bank_province" placeholder="" value="<?php echo $cup_details['province'] ?>"<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bank_city" class="col-sm-4 cup-label-acc control-label contest-label">  <?= lang('with_05') ?> <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="bank_city" class="form-control round-0" id="bank_city" placeholder="" value="<?php echo $cup_details['city'] ?>" <?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnZPContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?> > <?= lang('with-p-05') ?> </a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                <div class="col-md-11 col-centered tab-pane" id="bt-tab2">
                    ...
                    <form class="form-horizontal reg-frm">
                        <div class="alert alert-info" role-alert>
                            <i class="fa fa-info-circle"></i>You are about to withdraw funds to your local bank tranfer <?= strtoupper($currency)?>. This will be processed within 48 hours. Please make sure the information below is correct and complete.
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <p class="bt-val" id="txtBankAccountNumber"></p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <a id="btnZPBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" style="margin-right: 10px;"> <?=lang('wn_12');?> </a>
                                <a id="btnZPSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?=lang('wn_13');?> </a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="col-md-8 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtZPSuccessAmountRequested"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none" class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtZPSuccessFee"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtZPSuccessForexAccountNumber"></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="btn-create-another">
                                         <?php $link = 'withdraw/zotapay?wallet_id='.strtolower($currency); ?>
                                        <a href="<?php echo FXPP::loc_url($link)?>" class="create-another"><?= lang('with-p-16') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-8 col-centered">
                                    ...
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/bank-transfer-myr')?>" class="create-another"> <?= lang('with-p-16') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
