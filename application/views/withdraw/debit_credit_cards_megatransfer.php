        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title"> <?=lang('wdcc_00');?>[MegaTransfer] </h4>
                    ...
                    <form class="form-horizontal reg-frm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a id="btnMegatransferCardSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?=lang('wdcc_19');?></a>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-6 control-label"> <?=lang('wdcc_16');?>:</label>
                                            <div class="col-sm-6">
