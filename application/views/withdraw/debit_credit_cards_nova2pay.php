            ...
            <div class="banktrans-option" id="bt">
                <div class="row tab-content">
                    <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                        <h4 class="with-title"> Withdrawal Option - Nova2Pay</h4>
                        ...
                        <div class="form-group">
                            <input type="hidden" name="card_opt" value="np">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-8 col-centered">
                                        ...
                                        <div class="btn-create-another">
                                            <a href="<?php echo base_url('withdraw/nova2pay')?>" class="create-another"> <?=lang('wdcc_29');?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
