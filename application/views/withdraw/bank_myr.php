        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title">Withdraw via local bank transfer in MYR</h4>
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawBankMyr')) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                   <input type="text" name="chinaUnionPay_account" class="form-control round-0 numeric" id="chinaUnionPay_account" placeholder="" value="<?php echo $cup_details['bank_account_number'] ?>"<?php echo $disabled ?>>
                            </div>
                            <div class="reqs col-sm-3">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnBankMyrContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?> > <?= lang('with-p-05') ?> </a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                    ...
                    <form class="form-horizontal reg-frm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <p class="bt-val" id="txtChinaUnionPayAccount"></p>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <a id="btnBankMyrBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" style="margin-right: 10px;"> <?=lang('wn_12');?> </a>
                                <a id="btnBankMyrSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?=lang('wn_13');?> </a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="col-md-8 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtChinaUnionPaySuccessAmountRequested"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtChinaUnionPaySuccessForexAccountNumber"></p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="frm-val" id="txtChinaUnionPayaccSuccess"></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
