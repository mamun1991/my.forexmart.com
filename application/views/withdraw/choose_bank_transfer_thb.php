...
<div class="deposit-cards-holder">
    ...
    <ol class="breadcrumb internal-breadcrumb">
        ...
        <li class="active">Withdraw via Local bank transfer in Thailand</li>
    </ol>
    <div class="debit-credit-row">
        ...
        <div class="debit-col">
            <div class="debit-credit-holder">
                ...
                <a class="submit_bonus"  data-type="bank-transfer-thb" href="#"> Withdraw PayTrust</a>
            </div>
        </div>
        <div class="debit-col">
            <div class="debit-credit-holder">
...
<script type="text/javascript">
    $('.submit_bonus').click(function(event) {
        ...
        var url ='<?= FXPP::loc_url('withdraw');?>/' + type + '?wallet_id=thb';
