...
<div class="section rebate-system-container">
    <h1>Cashback Program</h1>
    <!--<p>Rebate System
        Let's make our partnership more effective and rewarding. ForexMart is much delighted to unveil our
        Rebate System, another great opportunity to earn higher commission. </p>
    <p>
        Under this system, we pay a portion of the spread and give it to partners. In exchange, affiliates pay
        off part of the commission to clients. Partners can return a rebate of up to 0,8 pips to the client,
        which can be given daily, weekly, or monthly.</p>
    <p>
        Affiliates can create as many rebate projects as they can. Each project can be activated, deactivated,
        modified, or removed by logging into the
        Partner Cabinet.</p>
    </p>-->
    <div class="acct-tab-holder">
        <ul role="tablist" class="main-tab">
               <li class="part-li <?= $nav=='statistics'?'active':""?>" role="presentation"><a href="<?= FXPP::loc_url('cash-back');?>" <?= $nav=='statistics'?'class="acct-active"':""?>><i class="fa fa-bar-chart"></i> Statistics</a></li>
