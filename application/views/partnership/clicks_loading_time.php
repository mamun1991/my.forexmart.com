    ...
    <div role="tabpanel" class="tab-pane active" id="commission">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <button type="button" class="btn btn-primary btnapply" id="hide_div"><?= lang('show_chart');?></button>
                <button type="button" class="btn btn-primary btnapply" id="show_div"><?= lang('show_chart');?></button>
...
var getDateTo = "<?php echo date('Y-m-d') ; ?>";
   ...
   <?php if(true){?>
    ...
    function getCommissionData(getDateFrom, getDateTo, getCumulative){
        ...
        $.ajax({
            type: 'POST',
            url:'/partnership/getCommission_v3333',
            data: {from:getDateFrom, to:getDateTo, cumulative:getCumulative},
            dataType: 'json',
            beforeSend: function(){
                $('#loader-holder').show();
