        ...
        <div class="row">
            <div class="col-sm-12">
                <p style="margin-top: 5px;" class="">
                    <b> Total commission: <span id="totalCommission"><?php echo $getCommissionData['totalCommission'];?></span></b>
                </p>
            </div>
        </div>
            ...
            <div class='col-md-8'>
                <div class="form-group">
                    <ul class="nav nav-pills">
                        ...
                        <li><a href="javascript:void(0)" id="day">Day</a></li>
                        <li><a href="javascript:void(0)" id="week">Week</a></li>
                        <li><a href="javascript:void(0)" id="month">Month</a></li>
                        <li><a href="javascript:void(0)" id="three_months">3 Months</a></li>
                        <li><a href="javascript:void(0)" id="year">Year</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function () {
        ...
        var date_from = "<?php echo $getCommissionData['startDate'];?>";
        var date_to = "<?php echo $getCommissionData['endDate'];?>";
        ...
        $('#part-table').DataTable({
            ...
            ajax:{
                type: 'post',
                url: '/test/getAllCommissionPaginate',
                dataType: 'json',
                data: function(d){
