...
$isMicro = false;
if( FXPP::isMicro($this->session->userdata('user_id'))){
    $isMicro = true;
}
...
<div class="info">
    ...
    <div class="afflink-holder-partner" style="display: none">
        <p class="affiliate-code"> <?= lang('parnav_01'); ?>:
            <span><?php echo FXPP::www_url('register?id=' . $affiliate_code); ?></span></p>
...
<?php } else { ?>
    ...
    <div class="affiliateCodeActiveBD" style="display: none">
        <p> <?= lang('parnav_01'); ?>: <span><?php echo FXPP::www_url('register?id=' . $affiliate_code); ?></span></p>
    ...
    <p class="affiliateCodeReqSend" style="display: none; font-size: 17px;  color: #29A643; font-weight: bold; ">
        Request for affiliate link is sent. </p>
...
<div class="acct-tab-holder">
    <ul role="tablist" class="nav nav-tabs partab arabic-main-tab arabic-partnership-main-tab">

        <?php if(!$isMicro){?>
        <?php if (!$isCPA && $PartnershipAgreementStatus->type_of_partnership != 'extra_commission') { ?>
            <li class="between"><a id="pn1" href="<?= FXPP::loc_url('partnership/commission'); ?>"
                                   class="<?php echo $active_sub_tab == 'commission' ? 'acct-active' : '' ?>">
                    <i class="fa fa-database"></i> <?= lang('parnav_04'); ?>
                </a></li>
        <?php } else if ($isCPA && $PartnershipAgreementStatus) { ?>
            <li class="between">
                <a id="pn1" href="<?= FXPP::loc_url('partnership/cpa'); ?>"
                   class="<?php echo $active_sub_tab == 'cpa' ? 'acct-active' : '' ?>">
        ...
        <?php if (!$PartnershipAgreementStatus) { ?>
            ...
            <li class="between"><a id="pn3" href="<?= FXPP::loc_url('graph'); ?>"
                                   class="<?php echo $active_sub_tab == 'graph' ? 'acct-active' : '' ?>">
        ...
        <?php }?>
            ...
            <li class="between">
                <a id="pn3" href="<?= FXPP::loc_url('partnership/affiliate-umbrella'); ?>"
                   class="<?php echo $active_sub_tab == 'affiliate-umbrella' ? 'acct-active' : '' ?>">
                    <i class="fa fa-slideshare"></i> Internal Transit Service
                </a>
            </li>
        <?php } ?>
        ...
        <?php if ($isCPA || $PartnershipAgreementStatus->type_of_partnership == 'extra_commission') { ?>
            ...
            <li class="between"><a id="pn4" href="<?= FXPP::loc_url('partnership/affiliate-custom-link'); ?>"
                                   class="<?php echo $active_sub_tab == 'affiliate' ? 'acct-active' : '' ?>">
                    <i class="fa fa-slideshare"></i> <?= lang('parnav_07'); ?>
                </a></li>
        <?php } ?>
        <li class="between view1">
            <a id="pn4" href="<?= FXPP::loc_url('partnership/internal-transfer'); ?>"
               class="<?php echo $active_sub_tab == 'internal_transfer' ? 'acct-active' : '' ?>">
                <i class="fa fa-slideshare"></i> <? //=lang('parnav_07');?> Internal Transit Service
            </a>
        </li>
        <?php if ((IPLoc::WhitelistPIPCandCC() && $PartnershipAgreementStatus->type_of_partnership == 'extra_commission')) { ?>
            <li class="between view1"><a id="pn5" href="<?= FXPP::loc_url('partnership/extra-commission'); ?>"
                                         class="<?php echo $active_sub_tab == 'extra_commission' ? 'acct-active' : '' ?>">
                    <i class="fa fa-database"></i> <?= lang('parnav_09'); ?>
                </a></li>
        <?php } ?>


        <li class="dropdown view2 more">
            <a href="#" id="moremenu" class="dropdown-toggle" data-toggle="dropdown">
                <?= lang('par_nav_M'); ?>
                <span class="caret"></span>
            </a>
            <ul class="dropdown-menu ulbg">
                <?php if (!$isCPA && $PartnershipAgreementStatus->type_of_partnership != 'extra_commission') { ?>
                    <li class="dropdown view2"><a id="pn4"
                ...
                <li class="between"><a id="pn4" href="<?= FXPP::loc_url('graph'); ?>"
                                       class="<?php echo $active_sub_tab == 'graph' ? 'acct-active' : '' ?>">
                ...
                <li class="dropdown view2">
                    <a id="pn4" href="<?= FXPP::loc_url('partnership/internal-transfer'); ?>"
                       class="<?php echo $active_sub_tab == 'internal_transfer' ? 'acct-active' : '' ?>">
                        <i class="fa fa-slideshare"></i> <? //=lang('parnav_07');?> Internal transfer service
                    </a>
                </li>


                <li class="dropdown view2"><a id="pn4" href="<?= FXPP::loc_url('spread-projects'); ?>"
                                              class="<?php echo $active_sub_tab == 'affiliate' ? 'acct-active' : '' ?>">
                        <i class="fa fa-slideshare"></i> <? //=lang('parnav_07');?> Spread Project
                    </a>
                </li>


                <li class="dropdown view2"><a id="pn4" href="<?= FXPP::loc_url('partnership/second-affiliates'); ?>"
                                              class="<?php echo $active_sub_tab == 'sub-ib-commission-tree' ? 'acct-active' : '' ?>">
                        <i class="fa fa-slideshare"></i> <? //=lang('parnav_07');?> Second Affiliates
                    </a>
                </li>

                <?php if ((IPLoc::WhitelistPIPCandCC() && $PartnershipAgreementStatus->type_of_partnership == 'extra_commission')) { ?>
                    <li class="dropdown view2"><a id="pn5" href="<?= FXPP::loc_url('partnership/extra-commission'); ?>"
                                                  class="<?php echo $active_sub_tab == 'extra_commission' ? 'acct-active' : '' ?>">
                            <i class="fa fa-database"></i> <?= lang('parnav_09'); ?>
                        </a></li>
                <?php } ?>
            ...
            <li class="between view1"><a id="pn6"  href="<?= FXPP::loc_url('partnership/extra-commission');?>" class="<?php echo $active_sub_tab == 'extra_commission' ? 'acct-active' : '' ?>">
                    <i class="fa fa-database"></i> <?=lang('parnav_09');?>
                </a></li>
            <li class="dropdown view2" >
                <a href="#" id="moremenu" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <ul class="dropdown-menu ulbg">
                    <li class="between"><a id="pn6"  href="<?= FXPP::loc_url('partnership/extra-commission');?>" class="<?php echo $active_sub_tab == 'extra_commission' ? 'acct-active' : '' ?>">
                            <i class="fa fa-database"></i> <?=lang('parnav_09');?>
                        </a></li>
                </ul>
            </li>
            ...
            $('#btn-afflink').click(function () {
                ...
                pblc['request'].done(function (data) {
                    if (data.isUpdated) {
                        ...
                        //  console.log(data.bdUserCheck+'----test');
