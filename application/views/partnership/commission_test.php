        ...
        <div class="row">
            <div class="col-sm-12">
                <p style="margin-top: 5px;" class="">
                    <b> <?=lang('com_10');?> <span id="totalCommission">
                        <?php //echo $getCommissionData['totalCommission'];?>
                    </span></b>
                </p>
            </div>
        </div>
...
<!--                        <li ><a href="#">--><?php //echo lang('part_all');?><!--</a></li>-->
                        ...
                        <li class="active"><a href="javascript:void(0)" id="year"><?=lang('part_year');?></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    function getCommissionData(getDateFrom, getDateTo, getCumulative){
        ...
        $.ajax({
            ...
            data: {from:getDateFrom, to:getDateTo, cumulative:getCumulative,type:''},
            dataType: 'json',
            beforeSend: function(){
                $('#loader-holder').show();
    ...
    $(function () {
        ...
        var date_from = "<?php echo date("Y-m-d",strtotime("- 1 year"));?>";
