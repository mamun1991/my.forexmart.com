...
.highcharts-container{
    ...
    /*table.part-table th:nth-of-type(5),*/
    /*table.part-table td:nth-of-type(5) {*/
    /*display: none;*/
    /*}*/
...
<!--                    lang('com_00');-->
        ...
        <div class="row">
            ...
            <div class="col-md-4 mbl-right">
                ...
                <button type="button" class="btn btn-primary btn-md btn-secondary" id="hide_div"><?= lang('show_chart');?></button>
                <button type="button" class="btn btn-primary btn-md btn-secondary" id="show_div"><?= lang('show_chart');?></button>
				
            </div>
        </div>

        <div class="row comsHeaderWeb">
            <div class='col-md-8'>
        ...
        <div class="row">
            <div class="col-sm-12">
                <p style="margin-top: 5px;" class="">
                    <b> <?=(lang('com_111'))?lang('com_111'):'Total Commission';?> <span id="totalCommission"><?php echo $getCommissionData['totalCommission'];?></span></b>
                </p>
            </div>
        </div>
        ...
        <div class="tab-content cur-tab-cont">
            <div role="tabpanel" class="tab-pane table-responsive active" id="close">
                <table class="table table-striped tab-my-acct part-table arabic-part-table testFxpp" id="part-table" name="part-table">
                    <thead>
                    <tr>
...
<!--						--><?php //} ?>
        ...
        <div class="row comsHeaderMob">
            <div class='col-md-8'>
                <div class="form-group ulday">
                    <ul class="nav nav-pills">
                        <!--<li ><a href="#">--><?php //echo lang('part_all');?><!--</a></li>-->
                        <li class="active ComButtonMob"><a href="javascript:void(0)" id="day"><?=lang('part_day');?></a></li>
                        <li class="ComButtonMob"><a href="javascript:void(0)" id="week"><?=lang('part_week');?></a></li>
                        <li class="ComButtonMob" ><a href="javascript:void(0)" id="month"><?=lang('part_month');?></a></li>
                        <!--                        <li ><a href="javascript:void(0)" id="three_months">--><?php //echo lang('part_tmonth');?><!--</a></li>-->
                        <!--                        <li ><a href="javascript:void(0)" id="year">--><?php //echo lang('part_year');?><!--</a></li>-->
                    </ul>
                </div>
...
var getDateTo = "<?php echo date('Y-m-d') ; ?>";
	...
	function getCommissionTableData(getDateFrom, getDateTo, getCumulative){
		$("#graph-div").hide();
		$("#com_com").hide();
		$("#show_div").show();
		$("#hide_div").hide();

		//console.log(getDateFrom+getDateTo+getCumulative);
        ...
        $.ajax({
            ...
            data: {date_from:getDateFrom, date_to:getDateTo, cumulative:getCumulative},
            dataType: 'json',
            beforeSend: function(){
                $('#loader-holder').show();
   ...
   <?php if(true){?>
    ...
    function getCommissionData(getDateFrom, getDateTo, getCumulative){
        ...
        var ajax_url = '/partnership/getCommission_v3';

        <?php }else{ ?>
        var ajax_url = '/partnership/getCommission_v2';
        <?php } ?>
    ...
    $(function () {
        ...
        $('#btn-apply').click(function(){
            ...
            getCommissionTableData(getDateFrom, getDateTo, getCumulative);
        ...
        $('ul.nav.nav-pills li a').click(function(e) {
            ...
            getCommissionTableData(newDate, dateNow, getCumulative);
...
$(document).on('click','#hide_div',function(){
	$("#graph-div").hide();
    $("#com_com").hide();
    $("#show_div").show();
    $("#hide_div").hide();
...
function myFunction(date,amont,acc,symbl) {
 //console.log(date+amont+acc+symbl+'Got the click');
}
