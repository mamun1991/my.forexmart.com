...
<div class="pamm-onclick-page destination-class page" id="pamm-div-partner">
    <?=$nav?>

    <div id="my-tab-content" class="tab-content pamm-tab-content " >
        <div class="tab-pane active" id="pamm-profile">
            <?php if(isset($_SESSION['partner_update'])){?>
                <div id="partner_registration_prompt" style="text-align: center;">
                    <?php if($_SESSION['partner_success']==True){?>
                        <div class="alert alert-success"><strong>Partner Update:</strong>  Update is successful.</div>
                    <?php }else{?>
                        <div class="alert alert-warning"><strong>Partner Update:</strong>  Update failed.</div>
                    <?php }?>
                </div>
                    <?php unset($_SESSION['partner_update']);?>
            <?php }else{?>

            <?php } ?>


            <?php if(isset($_SESSION['partner_register'])){?>
                <div id="partner_registration_prompt" style="text-align: center;">
                    <?php if($_SESSION['partner_success']==True){?>
                ...
                <?php unset($_SESSION['partner_register']);?>
            <?php }else{?>

            <?php } ?>

            <form action="<?=FXPP::my_url('pamm')?>" id="partner_registration" method="post"  accept-charset="UTF-8" autocomplete="off">
                ...
                <div class="pamm-content-input ">
                    ...
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12 deact" >
                        <label for="partnername" ><?= lang('pamm_31'); ?></label>
                        <input type="text" class="form-control round-0" placeholder="Name" name="partnername" id="partnername" value="<?= set_value('partnername') == false ? $name : set_value('partnername') ?>" readonly="readonly" maxlength="100"/>
                        <span class="red pull-r"><?php echo  form_error('partnername')?> </span>
                    </div>
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12 deact">
                        <label for="partneremail">
                            <!--E-mail-->
                            <?= lang('pamm_136')==""?lang('pamm_136'):"E-mail"; ?>
                        </label>
                        <input type="text" class="form-control round-0" placeholder="Name" name="partneremail" id="partneremail" value="<?= set_value('partneremail') == false ? $email: set_value('partneremail') ?>" readonly="readonly"  maxlength="100"/>
                        <span class="red "><?php echo  form_error('partneremail')?> </span>
                    </div>
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12 deact">
                        <label for="partnerinvestorpassword">
                            <!--Investor Password-->
                            <?= lang('pamm_137')==""?lang('pamm_137'):"Investor Password"; ?>
                        </label>
                        <input type="password" class="form-control round-0" placeholder="Investor password" name="partnerinvestorpassword" id="partnerinvestorpassword" value="76avrsd" readonly="readonly"  maxlength="10"/>
                        <span class="red "><?php echo  form_error('partnerinvestorpassword')?> </span>
                    </div>

                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12">
                        <label for="partnertraderpassword">
                            <!--Trader Password-->
                            <?= lang('pamm_138')==""?lang('pamm_138'):"Trader Password"; ?>
                        </label>
                        <input type="password" class="form-control round-0" placeholder="Trader password" name="partnertraderpassword" id="partnertraderpassword" maxlength="10" />
                        <span class="red "><?php echo  form_error('partnertraderpassword')?></span>
                        <?php if(isset($_SESSION['Trader_password'])){?>
                            <span class="red "><?php echo $_SESSION['Trader_password'];?></span>
                        <?php } ?>
                    </div>

                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12 deact">
                        <label for="partnerskype"><?= lang('pamm_32'); ?></label>
<input type="text" class="form-control round-0" id="partnerskype" name="partnerskype" placeholder="Skype" value="<?= set_value('partnerskype') == false ? (isset($infor['skype'])?$infor['skype']:'') : set_value('partnerskype') ?>" />
                                <span class="red"><?php echo  form_error('partnerskype')?> </span>
                    </div>
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12 deact">
                        <label for="partnericq"><?= lang('pamm_33'); ?></label>
                        <input id="partnericq" type="text" class="form-control round-0" name="partnericq" placeholder="ICQ" value="<?= set_value('partnericq') == false ? (isset($infor['icq'])?$infor['icq']:'') : set_value('partnericq') ?>"  maxlength="9"/>
                                <span class="red"><?php echo  form_error('partnerskype')?> </span>
                ...
                <div class="pamm-content-input deact">
                    ...
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12">
                        ...
                        <input type='hidden' value='0' name='partnercir'/>
                        <input type="checkbox" name="partnercir" id="partnercir" value="1" <?= set_value('partnercir') == false ? $check0 :  (set_value('partnercir')==1)?'checked':''  ?>/>
                        <label for="partnercir" id="lbl_partnercir">
                            <?= lang('pamm_35'); ?>
                        </label>
                        <span class="red">
                            <?php echo  form_error('partnercir')?>
                        </span>
                    </div>
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12">
                        <label  id="lbl_partnerlangauge" for="partnerlangauge"><?= lang('pamm_36'); ?></label>
                        <select class="form-control round-0 margin-ref select-box" name="partnerlangauge" id="partnerlangauge">
                        ...
                        <span class="red "><?php echo  form_error('partnerlangauge')?> </span>
                        <script type="text/javascript">
                            $().ready(function(){
                                $('select[name=partnerlangauge]').val('<?= set_value('partnerlangauge') == false ? (isset($infor['cfglang'])?$infor['cfglang']:'en') : set_value('partnerlangauge') ?>');
                                $('select[name=partnerlangauge]').select2({});
                            });
                        </script>
                    </div>
                </div>
                <div class="pamm-content-input">
                    <?php if($partner_registration==true){?>
                        <div class="custom_h1_uline">
                            <label class="custom_h1">
                                <?= lang('pamm_37'); ?>
                            </label>
                    ...
                    <div class="pamm-content-input-box col-lg-8 col-md-10 col-sm-12 col-xs-12">
                        <?php if($partner_registration==true){?>
                            ...
                            ?>
                            <input type='hidden' value='0' name='partner_checkbox_deactivate' />
                            <input type="checkbox" name="partner_checkbox_deactivate" id="partner_checkbox_deactivate" class="custom_a" value="1" <?= set_value('partner_checkbox_deactivate') == false ? $check1 :  (set_value('partner_checkbox_deactivate')==1)?'checked':''  ?> />
                            <label id="lbl_partner_checkbox_deactivate"><?= lang('pamm_37'); ?></label>
                            <span class="red "><?php echo  form_error('partner_checkbox_deactivate')?> </span>
                        <?php }?>
                        <style type="text/css">
                            .custom_a{
                                margin: 10px auto;
...
<script type="text/javascript">
    var destination = '#pamm-div-partner';
...
<script type="application/javascript">
    ...
    $('#partner_registration').validate({ // initialize the plugin
        rules: {
            partnername:  "required",
            partneremail: "required",
            partnerinvestorpassword:  "required",
            partnertraderpassword:  "required",
//            partnerskype:  "required",
            partnericq:  {
//                required:true,
                number: true,
                maxlength: 9,
            },
//            partneryahoo:  "required",
        },
        messages: {
            partnername:  "Please enter your Full name",
            partneremail: "Please enter your E-mail",
            partnerinvestorpassword:  "Enter investor password.",
            partnertraderpassword:  "Enter trader password.",
            partnerskype:  "Please enter skype account",
            partnericq: {
                required:"Please enter icq account.",
                number:"Please enter icq account numbers.",
            },
            partneryahoo:  "Please enter yahoo account",
        },
...
//    $('[data-toggle="tooltip"]').tooltip();
    ...
    $(document).on("click", "#lbl_partnerlangauge", function () {
        $('#partnerlangauge').select2('focus');
        $('#partnerlangauge').select2('open');
    });
    $(document).on("click", "#lbl_partner_checkbox_deactivate", function () {
        $('input[name=partner_checkbox_deactivate]').trigger('click');
    });
    $(document).on("click", "#lbl_partnercir", function () {
        $('input[name=partnercir]').trigger('click');
    });

    $( window ).load(function() {
        $('#pamm-div-partner').removeClass('page');
    });
</script>