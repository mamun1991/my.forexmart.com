<div class="pamm-onclick-page destination-class" id="pamm-div-trader">
    <?=$nav;?>
    <div id="my-tab-content" class="tab-content pamm-tab-content centeralign">
        <div id="pamm-profile">
            <p><label>An error ocurred</label></p>
            <p><label>PAMM traders can not make investment. Please login as PAMM investor.</label></p>
        </div>
