...
<!--                </div>-->
                ...
                <div class="pamm-investment-secondary">
                    ...
                    <!--<div class="pamm-investment-table">-->
                        <table class="pamm-text-table" cellspacing="0" cellpadding="0">
                            <tbody>
                            <tr>
                                ...
                                <td style="font-size: 100%; text-align: left; width: 280px; vertical-align: top" class="pamm-text-desc without-border">
                                    PAMM project visitor statistics for the specified period.                                    </td>
                                </tr>
                                <tr class="pamm-text-desc-hidden">
                                    <td>PAMM project visitor statistics for the specified period. </td>
                                </tr>
                            </tbody>
                        </table>
                    <!--</div>-->
...
.pamm-text-desc-hidden {
    display:none;
}

@media screen and (max-width: 674px) {

    .pamm-text-table , .pamm-text-table  table {
        width:100%!important;
    }
...
@media screen and (max-width: 552px){
    ...
    @media screen and (max-width: 570px) {
        .pamm-investment-table { max-width:100%;}
        .pamm-investment-table {
            max-width:100%;
            margin:0 auto!important;
        }
