<div class="tab-pane active" id="my-investments">
    <div class="pamm-investment-container">
        <h5>Make an investment to PAMM-account 5082655 (fxsystem 5082655)</h5>
        <div class="pamm-investment-parent">
            ...
            <button type="submit">Monitoring Page</button>
        </div>
        <div class="pamm-investment-secondary">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pamm-trader-condition-child">
                ...
                <input class="form-control round-0" type="text">
                <span>USD</span>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pamm-trader-condition-child">
                <label>Maximal investment amount</label>
                <span class="max-investment-amount">0.00 USD</span>
            </div>
            <button type="submit">Make an investment</button>
        </div>
    </div>
</div>
