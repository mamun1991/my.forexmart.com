                        ...
                        <div role="tabpanel" class="tab-pane active" id="personal">
                             <div class="col-lg-12 col-md-12 col-centered">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control round-0 required" id="street" name="street">
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control round-0 required" id="city" name="city">
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control round-0 required" id="state" name="state">
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control round-0 required" id="zip" name="zip">
                                    </div>
                                    ...
                                    <label for="Phone number" class="col-sm-3 control-label"><?=(lang('int_reg_51')!='')?lang('int_reg_51'):'Phone number'?><cite
                                            class="req">*</cite></label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control round-0 required" value="<?="+".$calling_code ?>"  id="Phone_number" name="Phone_number">
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
<!--                                        <div id="datepicker" data-date="01/01/2002"></div>-->
<!--                                        <input type="hidden" class="required" id="dob" name="dob">-->
                                        <input type="text" class="form-control round-0 datepicker required" id="dob" name="dob">
                                    </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" class="form-control round-0" placeholder="main account refareel code" value="<?=$aff_code?>" name="hidden_affiliate_code">
                                        <input type="text" class="form-control round-0" placeholder="Affiliate code" value="<?=$aff_code?>" name="affiliate_code">
