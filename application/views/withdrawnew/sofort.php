        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-12 col-centered tab-pane active" id="bt-tab1">
                    ...
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawSofort')) ?>
                    ...
                    <div class="form-group">
                        <label for="sofortAccount" class="col-sm-4 control-label contest-label">
                            <?=lang('wsof_05');?>

                            <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="sofort_account" class="form-control round-0" id="sofortAccount" placeholder=""<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnSofortContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?>>
                                <?=lang('wsof_06');?>
                    ...
                    <form class="form-horizontal reg-frm">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label">
                                ...
                                <span class="reqs1">*</span></label>
                            <div class="col-sm-6">
                                <p class="bt-val" id="txtSofortAccount"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label"></label>
                            <div class="col-sm-6">
                                <a id="btnSofortBack"  aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" >
                                    <?=lang('wsof_13');?>
                                </a>
                                <a id="btnSofortSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option">
                                    <?=lang('wsof_14');?>
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-10 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtSofortSuccessSofortAccount"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label">
                                    ...
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/sofort')?>" class="create-another">
                                            <?=lang('wsof_23');?>
