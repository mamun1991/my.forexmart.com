        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title">
                       Withdraw Option - Inpay
                    </h4>
                    <input type="hidden" name="hidden-lang" id="hidden-lang" value = "<?= FXPP::html_url()?>">
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawInpay')) ?>
                  ...
                  <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-4 control-label contest-label"></label>
                        <div class="col-sm-5">
                            <a id="btnInpayContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?>>Continue</a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                    ...
                    <form id="frmReview" class="form-horizontal reg-frm">
                      ...
                      <!--  <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label"></label>
                            <div class="col-sm-6">
                                <a id="btnInpayBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option">
                                    <?=lang('wbt_32');?>
                                </a>
                                <a id="btnInpaySendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option">
                                    <?=lang('wbt_33');?>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-centered">
                                    ...
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/inpay')?>" class="create-another">
                                            <?=lang('wbt_42');?>
                                        </a>
                                    </div>
                                </div>
