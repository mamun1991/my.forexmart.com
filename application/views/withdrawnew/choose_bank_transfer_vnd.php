...
<div class="deposit-cards-holder">
    <h1>Local bank transfer in Vietnam</h1>
    <ol class="breadcrumb internal-breadcrumb">
        ...
        <li class="active">Withdraw via Local bank transfer in Indonesia</li>
    </ol>
    <div class="debit-credit-row">

        <div class="debit-col">
            <div class="debit-credit-holder">
                <img src="<?= $this->template->Images() ?>payment_getway_logo/vnd-cards.png" class="img-reponsive" style="height: 100px;margin:10px">

                <a class="submit_bonus"  data-type="bank-transfer-vnd" href="#"> Withdraw PayTrust</a>
            </div>
        </div>
        <div class="debit-col">
            <div class="debit-credit-holder">
        ...
        <div class="debit-col">
            <div class="debit-credit-holder">
                <img src="<?= $this->template->Images() ?>payment_getway_logo/vnd-cards.png" class="img-reponsive" style="height: 100px;margin:10px">
                <a class="submit_bonus" data-type="payment-asia" href="#"> Withdraw PaymentAsia</a>
            </div>
        </div>
...
<script type="text/javascript">
    $('.submit_bonus').click(function(event) {
        ...
        var url ='<?= FXPP::loc_url('withdraw');?>/' + type + '?wallet_id=vnd';
