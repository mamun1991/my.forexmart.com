        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    ...
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawPaxum')) ?>
                    ...
                    <div class="form-group">
                        <label for="paxumID" class="col-sm-4 control-label contest-label">
                            <?=lang('pax_05');?>

                            <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="paxum_id" class="form-control round-0" id="paxumID" placeholder=""<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnPaxumContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?>>
                                <?=lang('pax_06');?>
                    ...
                    <form class="form-horizontal reg-frm">
                        <div class="alert alert-info" role-alert>
                            ...
                            <?php if(IPLoc::Office() && (FXPP::html_url() == 'sa' || FXPP::html_url() == 'pk')) {
                                echo 'You are about to withdraw funds to your Paxum account. This will be processed within 1-7 working hours. Please make sure the information below is correct and complete.';
                            }else{?>
                                <?=lang('pax_08');?>
                            <?php } ?>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label">
                                ...
                                <span class="reqs1">*</span></label>
                            <div class="col-sm-6">
                                <p class="bt-val" id="txtPaxumID"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label"></label>
                            <div class="col-sm-6">
                                <a id="btnPaxumBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" style="margin-right: 10px" class="btn-withdraw-option">
                                    <?=lang('pax_13');?>

                                </a>
                                <a id="btnPaxumSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option">
                                    <?=lang('pax_14');?>
                                ...
                                <div class="col-md-8 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtPaxumSuccessAmountRequested"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtPaxumSuccessAccountNumber"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtPaxumSuccessPaxumID"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtPaxumSuccessTransactionNumber"></p>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/paxum')?>" class="create-another">
                                            <?=lang('pax_23');?>
