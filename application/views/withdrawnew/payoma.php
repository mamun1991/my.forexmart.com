...
<?php $this->load->view('finance_nav.php');?>
    ...
    <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
        <h4 class="with-title"> Withdrawal Option - Payoma </h4>
        ...
        <?php //if(!$partner_verified){ $disabled =  ' disabled="disabled"';?>
           <!-- <div class="form-group">
                <div class="col-sm-12">
                    <div class="alert alert-danger" role="alert"> Your partner account is not verified</div>
                </div>
            </div>-->
            <?php //}?>
        ...
        <form class="form-horizontal reg-frm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <a id="btnPayomaSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?=lang('wdcc_19');?></a>
                </div>
            </div>
        </form>
    </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-centered">
                        ...
                        <div class="btn-create-another">
                            <a href="<?php echo base_url('withdraw/debit-credit-cards')?>" class="create-another"> <?=lang('wdcc_27');?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php include 'debit_credit_megatransfer.php'; ?>