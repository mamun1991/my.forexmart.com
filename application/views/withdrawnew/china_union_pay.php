        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title"><?= lang('chinapay-opt-01') ?></h4>
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawChinaUnionPay')) ?>
                    <?php if(!$disable_input){ ?>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="alert alert-danger" role="alert"><?= lang('chinapay-opt-01') ?></div>
                            </div>
                        </div>
                    <?php }else{ ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnChinaUnionPayContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?> > <?= lang('with-p-05') ?> </a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                <div class="col-md-11 col-centered tab-pane" id="bt-tab2">
                    ...
                    <form class="form-horizontal reg-frm">
                        <div class="alert alert-info" role-alert>
                            <i class="fa fa-info-circle"></i><?= lang('chinapay-opt-03') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <a id="btnChinaUnionPayBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" style="margin-right: 10px;"> <?=lang('wn_12');?> </a>
                                <a id="btnChinaUnionPaySendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?=lang('wn_13');?> </a>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-centered">
                                    ...
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/chinaUnionPay')?>" class="create-another"><?= lang('with-p-16') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
