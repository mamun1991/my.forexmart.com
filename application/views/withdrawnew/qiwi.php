        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title"> Withdrawal Option - Qiwi </h4>
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawQiwi')) ?>
                    ...
                    <div class="form-group">
                        <label for="qiwi_id" class="col-sm-4 control-label contest-label"> Client's mobile number <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="qiwi_id" class="form-control round-0" id="qiwi_id" placeholder=""<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnQiwiContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?>><?= lang('wbt_16');?></a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                <div class="col-md-11 col-centered tab-pane" id="bt-tab2">
                    ...
                    <form class="form-horizontal reg-frm">
                        <div class="alert alert-info" role-alert>
                            <i class="fa fa-info-circle"></i>You are about to withdraw funds to your QIWI Account. This will be processed within 48 hours. Please make sure the information below is correct and complete.
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label">Client's mobile number <span class="reqs1">*</span></label>
                            <div class="col-sm-6">
                                <p class="bt-val" id="txtQiwiId"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label"></label>
                            <div class="col-sm-6">
                                <a id="btnQiwiBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" style="margin-right: 10px;"> <?= lang('wwebm_12');?> </a>
                                <a id="btnQiwiSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?= lang('ukash_bu');?> </a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="col-md-8 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtQiwiSuccessAmountRequested"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtQiwiSuccessAccountNumber"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label">Client's mobile number :</label>
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtQiwiSuccessQiwiId"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label"><?= lang('wwebm_20');?> :</label>
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtQiwiSuccessTransactionNumber"></p>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/qiwi')?>" class="create-another"> <?= lang('wwebm_24');?> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
