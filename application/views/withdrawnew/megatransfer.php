        ...
        <div class="banktrans-option" id="bt">
            <div class="row tab-content">
                <div class="col-md-11 col-centered tab-pane active" id="bt-tab1">
                    <h4 class="with-title"> Withdrawal Option - MegaTransfer </h4>
                    <?php echo form_open(base_url('/withdraw'), array('class' => 'form-horizontal reg-frm', 'id' => 'frmWithdrawMegaTransfer')) ?>
                    ...
                    <div class="form-group">
                        <label for="megatransfer_username" class="col-sm-4 control-label contest-label"> MegaTransfer Username <span class="reqs1">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" name="megatransfer_username" class="form-control round-0" id="megatransfer_username" placeholder=""<?php echo $disabled ?>>
                        </div>
                        <div class="reqs col-sm-3">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a id="btnMegaTransferContinue" aria-controls="bt-tab2" role="tab" data-toggle="tab" class="btn-withdraw-option"<?php echo $disabled ?>><?= lang('wbt_16');?></a>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
                <div class="col-md-11 col-centered tab-pane" id="bt-tab2">
                    ...
                    <form class="form-horizontal reg-frm">
                        <div class="alert alert-info" role-alert>
                            <i class="fa fa-info-circle"></i>You are about to withdraw funds to your MegaTransfer Account. This will be processed within 48 hours. Please make sure the information below is correct and complete.
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label"> MegaTransfer username <span class="reqs1">*</span></label>
                            <div class="col-sm-6">
                                <p class="bt-val" id="txtMegaTransferUsername"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-6 control-label contest-label"></label>
                            <div class="col-sm-6">
                                <a id="btnMegaTransferBack" aria-controls="bt-tab1" role="tab" data-toggle="tab" class="btn-withdraw-option" style="margin-right: 10px;"> <?= lang('wwebm_12');?> </a>
                                <a id="btnMegaTransferSendRequest" aria-controls="bt-tab3" role="tab" data-toggle="tab" class="btn-withdraw-option"> <?= lang('ukash_bu');?> </a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="col-md-8 col-centered">
                                    ...
                                    <form class="form-horizontal form-success">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtMegaTransferSuccessAmountRequested"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtMegaTransferSuccessAccountNumber"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label">MegaTransfer username :</label>
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtMegaTransferSuccessMegaTransferUsername"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-6 control-label"><?= lang('wwebm_20');?> :</label>
                                            <div class="col-sm-6">
                                                <p class="frm-val" id="txtMegaTransferSuccessTransactionNumber"></p>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="btn-create-another">
                                        <a href="<?php echo FXPP::loc_url('withdraw/megatransfer')?>" class="create-another"> <?= lang('wwebm_24');?> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
