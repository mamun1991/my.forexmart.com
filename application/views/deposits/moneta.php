    ...
    <div class="col-lg-11 col-centered tab-pane active" id="nt-tab">
     ...
     <input type="hidden" name="bounusfiled" value="<?=(set_value('bounusfiled'))?set_value('bounusfiled'):$bounusfiled?>">
                ...
                <div class="form-group" style= "text-align: center;">
                    ...
                    <?php if($error_msg){?>
                        ...
                        <?php if($error_msg == "Spanish client"): ?>
                            ...
                            <?php echo FXPP::spanishValidationView("moneta"); ?>
            ...
            <?php } ?>
             ...
             <?php $tranResult=$this->session->flashdata('moneta_transaction');if(!empty($tranResult)){?>
            <div class="form-group transection" id="transection"><?=$tranResult?></div> <?php } ?>

            <div class="form-group" style="text-align: left;">
                <img src="<?= $this->template->Images()?>moneta.png" border="0" alt="" style="width: 203px; margin-bottom: 15px;"/>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="sum" id="sum"   value="<?=floatval($amount)?>"  class="form-control round-0"<?php echo $disabled ?> title="Minimum 100 rur" required="required">
