<div class="col-lg-12 col-md-12 col-sm-12 int-main-cont">
    <div class="section">
        <div class="deposit-cards-holder">
            <h1>Deposit via local bank transfer in IDR</h1>
            <ol class="breadcrumb internal-breadcrumb">
                <li><a href="<?= FXPP::loc_url('deposit') ?>">Finance</a></li>
                <li><a href="<?= FXPP::loc_url('deposit') ?>">Deposit</a></li>
                <li class="active">Deposit via local bank transfer in IDR</li>
            </ol>
            <div class="card-row">
                <div class="card-col">
            ...
            <p class="card-text">
                ForexMart accepts deposit via the biggest banks of <span>Indonesia</span>.
            </p>
            <p class="card-text">
            ...
            <p class="card-text card-cont-text">
                For more details, you may reach us through the following:
            </p>
            <div class="card-cont-holder">
               ...
               <!-- <p style="font-size: 15px"><b>Depositor 1</b></p>
                ...
                <?php } ?>
                <p style="font-size: 15px"><b>Depositor 1</b></p>
                <p><img src="<?= $this->template->Images() ?>contact-yahoo.png" width="24"> :  forexmartbdg@gmail.com — +6285871496934</p>
                <p><img src="<?= $this->template->Images() ?>contact-whatsapp.png" width="24"> : +6285871496934</p>

                <p style="font-size: 15px"><b>Depositor 2 </b></p>
