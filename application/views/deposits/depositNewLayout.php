...
<!--                            }-->
                ...
                <div class="hidden-finance-dep-local paymentforidr">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 local-bank-content">
                        <img class="img-responsive" src="<?= $this->template->Images()?>/30-percent-bonus.png"/>
                    </div>
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-8 local-bank-content">
                        <p><?= lang('opportunity');?></p>
                    </div>

                    <div class="finance-total-amount finance-local-total-amount col-lg-4 col-md-4 col-sm-4 col-xs-12 hidden-xs ">
                ...
                <script type="text/javascript">
                    ...
                    function percent_calculation(value){
                        var result = parseFloat(value)*30/100;
                        return result;
                    }
                        ...
                        <div class="fdsc">
                            ...
                            <div class="parent-fin-dep-content">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 fin-dep-content-input2" id="img_show_percent2" style="    padding: 0;">
                                    ...
                                    <img src="<?= $this->template->Images()?>/30-percent-bonus.png" class="img-responsive img-other2" style="display: inline-block;">
                                </div>
