...
<div class="row">
    ...
    <form id = "idr_deposit_form" class="form-horizontal" method="POST" style="margin-top: 50px;margin-left: 10%;margin-right: 20%;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <div class="exchange-curr-container">
                    ...
                    <span id="curr"><?= $account['currency'] ?></span>
                </div>
            </div>
            ...
            <div class="reqs amount-err col-md-offset-5 col-md-5 errorlineshow" style="margin-top: 0;">
                <?php echo  form_error('deposit_idr_amt_validation')?>
...
<?php if(IPLoc::VPN_IP_Jenalie()){?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            exchange_currency($('#from_amount').val());

            $('#from_amount').bind('keyup input', function(){
                exchange_currency($(this).val());
            });

            $('#idr_deposit_form').submit(function() {
        ...
        function exchange_currency(amountFrom) {

            var currencyFrom = $("#curr").text(),
                currencyTo = 'IDR',
            ...
            $.ajax({
                ...
                dataType: 'json',
                beforeSend: function(){
                    $('#from_amount').prop('disabled', true); //To let conversion finish before enabling of changing in amount
                    $('.icon-container').show();
                },
                success: function(x) {
