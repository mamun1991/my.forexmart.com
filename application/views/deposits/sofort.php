...
.transection{text-align: center; background: rgb(223, 240, 216) none repeat scroll 0% 0%; height: 72px; line-height: 71px; margin-top: -31px; color: seagreen; font-size: 16px;}
...
$(document).ready(function(){
  setTimeout(function(){ $("#transection").remove(); }, 30000);   
})
...
<div class="row tab-content" style= "margin-bottom:20px">
...
<input type="hidden" name="bounusfiled" value="<?=(set_value('bounusfiled'))?set_value('bounusfiled'):$bounusfiled?>">
                ...
                <div class="form-group" style= "text-align: center;">
                    ...
                    <?php if($error_msg){?>
                        ...
                        <?php if($error_msg == "Spanish client"): ?>
                            ...
                            <?php echo FXPP::spanishValidationView("sofort"); ?>
            ...
            <?php } ?>
            <?php $tranResult=$this->session->flashdata('msg_transaction');if(!empty($tranResult)){?>
            <div class="form-group transection" id="transection"><?=$tranResult?></div> <?php } ?>
            

            <div class="form-group" style="text-align: center;">
                <img src="<?= $this->template->Images()?>sofortlogo.png" border="0" alt="" style="width: 203px; margin-bottom: 15px;"/>
            </div>
...
//                ?>
                ...
                <div class="col-sm-5 ">
                    <input type="text" name="sum" id="sum" value="" class="form-control round-0"<?php echo $disabled ?>  required="required">
...
<!--                </div>-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-offset-1 col-sm-5 cstm">
                    <button type="submit" class="cstm btn-submit"<?php echo $disabled ?> style=" margin-left: -20px">
                        <?=lang('ym_11');?>
                    </button>
