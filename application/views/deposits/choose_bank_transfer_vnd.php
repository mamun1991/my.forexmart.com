...
<div class="deposit-cards-holder">
    ...
    <ol class="breadcrumb internal-breadcrumb">
        ...
        <li class="active">Deposit via Local bank transfer in Vietnam</li>
    </ol>
    <div class="debit-credit-row">
        ...
        <div class="debit-col">
            <div class="debit-credit-holder">
                ...
                <a class="submit_bonus"  data-type="bank-transfer-vnd" href="#"> Deposit PayTrust</a>
            </div>
        </div>
        <div class="debit-col">
            <div class="debit-credit-holder">
        ...
        <div class="debit-col">
            <div class="debit-credit-holder">
                <img src="<?= $this->template->Images() ?>payment_getway_logo/vnd-cards.png" class="img-reponsive" style="height: 100px;margin:10px">
                <a class="submit_bonus" data-type="payment-asia" href="#"> Deposit PaymentAsia</a>
            </div>
        </div>
