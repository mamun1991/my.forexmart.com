...
<div class="deposit-cards-holder">
    ...
    <ol class="breadcrumb internal-breadcrumb">
        ...
        <li class="active">Deposit via Local bank transfer in Malaysia</li>
    </ol>
    <div class="debit-credit-row">
        ...
        <div class="debit-col">
            <div class="debit-credit-holder">
                ...
                <a class="submit_bonus"  data-type="bank-transfer-myr" href="#"> Deposit PayTrust</a>
            </div>
        </div>
        <div class="debit-col">
            <div class="debit-credit-holder">
