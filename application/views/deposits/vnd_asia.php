...
<h1>Deposit via PaymentAsia in VND</h1>

<div class="row">



    <form id = "china_union_payForm" class="form-horizontal" method="POST" action="" style="margin-top: 50px;margin-left: 10%;margin-right: 20%;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <div class="exchange-curr-container">
                    ...
                    <input type="number" id="from_amount" min="0" step="any" value="<?=floatval($amount)?>" class="form-control round-0 numeric depositamountcheck" placeholder="0.00" style="width: 45%">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <div class="exchange-curr-container">
                    ...
                    <input type="number" id="to_amount" min="0" step="any" value="" class="form-control round-0 numeric depositamountcheck" readonly="" style="width: 45%">
                    <span> VND </span>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input name="first_name" id="first_name" type="text" class="form-control round-0" <?php echo $disabled ?> value="<?= $first_name; ?>">
                <span class="firstname_error errorlineshow" style="color: red"> <?php echo  form_error('firstname')?></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-4 control-label">Last Name<cite class="req">*</cite></label>
            <div class="col-sm-5">
                <input name="last_name" id="last_name" type="text" class="form-control round-0" <?php echo $disabled ?> value="<?= $last_name; ?>">
                <span class="lastname_error errorlineshow" style="color: red"><?php echo  form_error('lastname')?> </span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-4 control-label">Phone number<cite class="req">*</cite></label>
            <div class="col-sm-5">
                <input name="phone_number" id="phone_number" type="text" class="form-control round-0" <?php echo $disabled ?> value="<?= $phone_number; ?>">
                <span class="phone_number_error errorlineshow" style="color: red"><?php echo  form_error('phone_number')?> </span>
            </div>
        </div>
