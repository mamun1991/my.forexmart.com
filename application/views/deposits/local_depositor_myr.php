        ...
        <div class="deposit-cards-holder">
            ...
            <?php if($isWithdraw){ ?>
                <ol class="breadcrumb internal-breadcrumb">
                    ...
                    <li class="active"><?= lang('trd_37'); ?></li>
                </ol>
            ...
            <?php }else{ ?>
                <ol class="breadcrumb internal-breadcrumb">
                    ...
                    <li class="active"><?= lang('trd_38'); ?></li>
                </ol>
            ...
            <div class="card-row">
            <div class="card-col">
					<a href="#"><img src="<?= $this->template->Images()?>cmaybank.png" class="img-responsive"></a>
				</div>
				<div class="card-col">
					<a href="#"><img src="<?= $this->template->Images()?>ccimb.png" class="img-responsive"></a>
				</div>
				<div class="card-col">
					<a href="#"><img src="<?= $this->template->Images()?>cpb.png" class="img-responsive"></a>
				</div>
				<div class="card-col">
					<a href="#"><img src="<?= $this->template->Images()?>crhb.png" class="img-responsive"></a>
				</div>
				<div class="card-col">
					<a href="#"><img src="<?= $this->template->Images()?>cambank.png" class="img-responsive"></a>
				</div>
            ...
            <div class="card-cont-holder">
                ...
                <?php if($isWithdraw){ ?>
                    <p style="font-size: 15px"><b><?= lang('trd_42'); ?></b></p>
                <?php }else{ ?>
                    <p style="font-size: 15px"><b><?= lang('trd_43'); ?></b></p>
                <?php }  ?>

                <p><img src="<?= $this->template->Images() ?>contact-email.png" width="24"> :  deposit-malaysia@forexmart.com</p>
                <p><img src="<?= $this->template->Images() ?>cellphone.png" width="24"> : +60 3-8656 7623</p>
                <p><img src="<?= $this->template->Images() ?>telegram.png" width="24"> : +60 1-9333 4112</p>
                <p><img src="<?= $this->template->Images() ?>contact-whatsapp.png" width="24"> : +60 1-933 34112</p>
