...
class Cash_back extends CI_Controller {
    ...
    public function statisticsData() {
        if($this->session->userdata('logged')){
            ...
            if($data= $this->partners_model->getCashbackStatisticsData($from,$to,$account_number,$this->session->userdata('account_number'))){
