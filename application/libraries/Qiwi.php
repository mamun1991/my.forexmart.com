...
{	
    ...
    public  function SendRequestResult()
    {
        ...
        curl_setopt($ch, CURLOPT_USERPWD, $this -> RestID . ":" . $this -> RestPassword);
            ...
            curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query( array('result_code'=>0) ) );
	...
	public function getResultDescription() {
		switch ($this->getResult()) {
			case 0:
				...
				break;
			case 5:
				$description = 'Incorrect data in the request parameters';
				break;
			case 13:
			...
			case 78:
				...
				break;
			case 150:
				$description = 'Authorization error (e.g. invalid login/password)';
				break;
			case 152:
				$description = 'Protocol is not enabled or protocol is disabled';
				break;
			case 155:
				$description = 'This merchant’s identifier (API ID) is blocked ';
				break;
			case 210:
				$description = 'Invoice not found';
				break;
			case 215:
				$description = 'Invoice with this bill_id already exists';
				break;
			case 241:
				$description = 'Invoice amount is less than allowed';
				break;
			case 242:
				$description = 'Invoice amount is greater than allowed';
				break;
			case 298:
			...
			case 303:
				...
				break;
			case 316:
				$description = 'Authorization from the blocked merchant';
				break;
			case 319:
				$description = 'No rights for the operation';
				break;
			case 339:
				$description = 'IP-addresses blocked';
				break;
			case 341:
				$description = 'Required parameter is incorrectly specified or absent in the request';
				break;
			case 700:
				$description = 'Monthly limit on operations is exceeded';
				break;
			case 774:
				$description = 'Visa QIWI Wallet user account temporarily blocked';
				break;
			case 1001:
				$description = 'Currency is not allowed for the merchant';
				break;
			case 1003:
				$description = 'No convert rate for these currencies';
				break;
			case 1019:
				$description = 'Unable to determine wireless operator for mobile commerce';
				break;
			case 1419:
				$description = 'Bill was already payed';
				break;
			default:
				$description = 'Payment processing error. Invoice has not been paid';
		}
		return $description;
	}
	...
	public function getStatusDescription() {
		switch ($this->getStatus()) {
			case 'waiting':
				$description = 'Invoice issued, pending payment';
				break;
			case 'rejected':
				$description = 'Invoice has been rejected';
				break;
			case 'expired':
				$description = 'Invoice expired. Invoice has not been paid';
				break;
			default:
				$description = 'Payment processing error. Invoice has not been paid';
		}
