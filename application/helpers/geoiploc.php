...
GeoIPLoc code & data last updated: Mon Nov 23 21:17:17 PST 2015.
...
{
   // return IPLoc::getCountryCode($ip);
    if($ip=="::1"){
        return "GB";
    }else{
      return IPLoc::getCountryCode($ip);
...
$GLOBALS['geoipaddrfrom'] = array();

$GLOBALS['geoipaddrupto'] = array();

$GLOBALS['geoipctry'] =array();

$GLOBALS['geoipcntry'] =array();

$GLOBALS['geoipcountry'] =array();

$GLOBALS['geoipcount'] = count($GLOBALS['geoipaddrfrom']);
