...
$lang['ps_dsc']='Log in to ForexMart Partner Cabinet by typing in your email or account number and password.';
$lang['ps_kew']='ForexMart | Partner Login';
$lang['ps_tit']='ForexMart | Partner Login';

$lang['cs_dsc']='Access client cabinet and manage ForexMart account.';
$lang['cs_kew']='ForexMart | Client Login';
$lang['cs_tit']='ForexMart | Client Login';

//Partner Signin
$lang['ps_01']='Sign in to Partner Area';
$lang['ps_02']='Login';
$lang['ps_03']='Password';
$lang['ps_04']='Forgot password?';
$lang['ps_05']='Sign In';

$lang['ps_06']='New to ForexMart?';
$lang['ps_07']='Partnership Registration';
$lang['ps_08']='Open a Demo Account';
$lang['ps_09']='Email or Account number';
$lang['ps_10']='Password';
$lang['ps_11']='Log in';

//Client Signin

$lang['cs_03_ac']='Account Number';
$lang['cs_01']='Sign in to Client Area';
/*$lang['cs_02']='You have successfully reset your password.';*/
$lang['cs_02']='Your new password has been sent to your E-mail';
$lang['cs_03']='Login';
$lang['cs_04']='Password';
$lang['cs_05']='Forgot Password?';
$lang['login_field']='Log in';
$lang['password_field']='Password';

$lang['cs_06']='Submit';
$lang['cs_07']='New to ForexMart?';
$lang['cs_08']='Open a <span class="text-green">Real Account</span>';
$lang['cs_09']='Open a Demo Account';
...
$lang['xnv_R'] = 'Register';
$lang['xnv_LO'] = 'Logout';
$lang['sideright1'] = 'Open an Account';
$lang['xnv_hi'] = 'Hi';
...
$lang['pn2-7_1'] = 'It operates under the authority of the Cyprus Securities and Exchange Commission (CySEC) (license number ';
$lang['pn2-7_2'] = ') and is registered under the following EU regulators: the French Autorité de Contrôle Prudentiel et de Résolution (ACPR) (Registration number 75426), the German Federal Financial Supervisory Authority (BaFin) (registration number 146395), and the British Financial Conduct Authority (FCA) (registration number 728735). ForexMart is a certified member of the Investor Compensation Fund (ICF) and is MiFID compliant according to the Investment Services and Regulated Market Law of 2007 (law number 144(I)2007). Forexmart is licensed to offer various investment services of Reception and transmission of orders in relation to one or more financial instruments, Execution of orders on behalf of clients, Dealing on own account, Portfolio management, Safekeeping and administration of financial instruments for the account of clients, including custodianship and related services such as cash/collateral management, Granting credits or loans to an investor to allow him to carry out a transaction in one or more financial instruments, where the firm granting the credit or loan is involved in the transaction, Foreign exchange services where these are connected to the provision of investment services and Investment research and financial analysis or other forms of general recommendation relating to transactions in financial instruments. All these services are offered in connection to financial instruments (transferable securities, options, futures, SWAPS, forward rate agreements, CFDs, and other derivatives).';
$lang['pn2-7_2-eu'] = ') and is registered under the following EU regulators: the French Autorité de Contrôle Prudentiel et de Résolution (ACPR) (Registration number 75426), the German Federal Financial Supervisory Authority (BaFin) (registration number 146395), and the British Financial Conduct Authority (FCA) (registration number 728735). ForexMart is a certified member of the Investor Compensation Fund (ICF) and is MiFID compliant according to the Investment Services and Regulated Market Law 87(I)2007. Forexmart is licensed to offer various investment services of Reception and transmission of orders in relation to one or more financial instruments, Execution of orders on behalf of clients, Dealing on own account, Portfolio management, Safekeeping and administration of financial instruments for the account of clients, including custodianship and related services such as cash/collateral management, Granting credits or loans to an investor to allow him to carry out a transaction in one or more financial instruments, where the firm granting the credit or loan is involved in the transaction, Foreign exchange services where these are connected to the provision of investment services and Investment research and financial analysis or other forms of general recommendation relating to transactions in financial instruments. All these services are offered in connection to financial instruments (transferable securities, options, futures, SWAPS, forward rate agreements, CFDs, and other derivatives).';
$lang['pn2-7_2-eu-2'] ='Forexmart is licensed to offer various investment services of Reception and transmission of orders in relation to one or more financial instruments, Execution of orders on behalf of clients, Dealing on own account, Portfolio management, Safekeeping and administration of financial instruments for the account of clients, including custodianship and related services such as cash/collateral management, Granting credits or loans to an investor to allow him to carry out a transaction in one or more financial instruments, where the firm granting the credit or loan is involved in the transaction, Foreign exchange services where these are connected to the provision of investment services and Investment research and financial analysis or other forms of general recommendation relating to transactions in financial instruments. All these services are offered in connection to financial instruments (transferable securities, options, futures, SWAPS, forward rate agreements, CFDs, and other derivatives).';
