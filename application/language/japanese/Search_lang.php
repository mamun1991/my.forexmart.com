...
$lang['s_7-a'] = '口座証明 | About | ForexMart';
...
$lang['s_9-a'] = 'タイ プ | MT4 Account'; // タイ プ means type google translate
...
$lang['s_21-a'] = 'パートナーリンク | ForexMart';
...
$lang['s_42-a'] = '信用に関するポリシー | ForexMart';
$lang['s_42-b'] = 'Privacy Policy Documentation';

$lang['s_43-a'] = 'リスク | ForexMart';
...
$lang['s_52-a'] = 'マイ口座 | ForexMart';
$lang['s_52-b'] = 'Personal users account';

$lang['s_53-a'] = 'マイ口座 | Open Trading Account | ForexMart';
$lang['s_53-b'] = 'Employment Details and Account Confirmation updates';

$lang['s_54-a'] = 'マイ口座 | 現在の取引 | ForexMart';
$lang['s_54-b'] = 'お客様の現在のお取引と延期されたオーダーをご確認ください。すでに終わった、または無効となった取引 を照会するには、「取引履歴」タブをご覧ください。';

$lang['s_55-a'] = 'マイ口座 | 取引履歴 | ForexMart';
$lang['s_55-b'] = '以下で必要な情報を入力し期間を区切ることで、全ての終了済み取引や延期された取引を照会することがで きます。';

$lang['s_56-a'] = 'マイ口座 | 取引履歴 | ForexMart';
...
$lang['s_57-a'] = 'マイプロフィール | 個人情報  | ForexMart';
$lang['s_57-b'] = 'Change personal information of personal account.';

$lang['s_58-a'] = 'マイプロフィール | パスワード変更   | ForexMart';
$lang['s_58-b'] = 'Change personal account password.';

$lang['s_59-a'] = 'マイプロフィール | パスワード変更   | ForexMart';
$lang['s_59-b'] = 'Upload documents in verifying personal user account.';

$lang['s_60-a'] = 'マイプロフィール | VPS | ForexMart';
$lang['s_60-b'] = 'MetaTrader 4 account information.';


$lang['s_61-a'] =  'Finance | Deposit | ForexMart';
$lang['s_61-b'] =  'Deposit, 引き出し, Transfer Between Accounts and Transaction History';

$lang['s_62-a'] =  'Finance | 引き出し | ForexMart';
$lang['s_62-b'] =  'Deposit, 引き出し, Transfer Between Accounts and Transaction History';

$lang['s_63-a'] =  'Finance | 引き出し | ForexMart';
$lang['s_63-b'] =  'Deposit, 引き出し, Transfer Between Accounts and Transaction History';

$lang['s_64-a'] =  'Finance | 決済履歴 | ForexMart';
$lang['s_64-b'] =  'Deposit, 引き出し, Transfer Between Accounts and Transaction History';

$lang['s_65-a'] =  'ボーナス | ボーナス | ForexMart';
$lang['s_65-b'] =  '社にとって、お客様のようなパートナーとの協力は優先課題となっております。私たち

は2種類のボーナスをご用意いたしております。30％のボーナスと、デポジット不要のボーナスです。お客

様はいつでも、口座に算入されたボーナス額を確認することができます。同一の取引口座に対し異なるタイ

プのボーナスを算入することはできませんのでご注意ください。';

$lang['s_66-a'] =  'ボーナス | ボーナスに関する情報 | ForexMart';
$lang['s_66-b'] =  '社にとって、お客様のようなパートナーとの協力は優先課題となっております。私たち
...
$lang['s_67-a'] =  'Partnertship | 手数料 | ForexMart';
$lang['s_67-b'] =  'Partnership Commisions Page';

$lang['s_68-a'] =  'Partnertship | クリック | ForexMart';
$lang['s_68-b'] =  'Partnertship  Clicks  Statistics';

$lang['s_69-a'] = 'Partnertship | レフェラル | ForexMart';
...
// currency-conversion
$lang['s_79-a'] = 'フォレックス・カリキュレーター | ForexMart';
...
//my location
$lang['s_82-a'] = 'お客様ページへログイン | ForexMart';
$lang['s_82-b'] = 'お客様ページへログイン  | ForexMart';
//client/signin
$lang['s_83-a'] = 'パートナーページへログイン | ForexMart';
$lang['s_83-b'] = 'パートナーページへログイン | ForexMart';
//partner/signin
$lang['s_83x-a'] = 'パスワードをお忘れですか?| ForexMart';
$lang['s_83x-b'] = 'パスワードをお忘れですか? | ForexMart';
//forgot-password
...
$lang['s_86-b'] = '世界のリーディングプロセッシングサービスプロバイダーに資金を預金してください。 Visaクレジットカードやデビットカードを利用し、取引口座に預け入れを行いましょう。';
//deposit/debit-credit-cards

$lang['s_87-a'] = 'Deposit Options - Skrill ';
$lang['s_87-b'] = 'Skrill (Moneybookers) ви дава възможност да прехвърляте средства по вашата търговска сметка и да получавате пари чрез имейл адрес.
Депозит чрез Skrill (Moneybookers) ';
//deposit/skrill

$lang['s_88-a'] = 'Deposit Options - Neteller';
$lang['s_88-b'] = '資金送金サービスを提供する独立企業として、Netellerは迅速で簡単な方法でお客様の取引口座へ預け入
...
$lang['s_90-b'] = 'Paypalは、簡単で安全な資金送金・オンライン決済手段です。';
//deposit/paypal
...
$lang['s_99-a'] = '口座振替 | ForexMart';
$lang['s_99-b'] = '口座振替 | ForexMart';
//transfer


$lang['s_100-a'] = 'ご友人紹介 - Invite by E-mail | ForexMart';
$lang['s_100-b'] = 'ご友人紹介 - Invite by E-mail | ForexMart';
//invite-friend/invite-by-email

$lang['s_101-a'] = 'ご友人紹介 - 私の友達 | ForexMart';
$lang['s_101-b'] = 'ご友人紹介 - 私の友達 | ForexMart';
//invite-friend/my-friends


$lang['s_102-a'] = 'ご友人紹介 - 情報 | ForexMart';
$lang['s_102-b'] = 'ご友人紹介 - 情報 | ForexMart';
...
$lang['s_107-a'] = 'Rebate-system - 情報| ForexMart';
...
$lang['s_108-b'] = '世界のリーディングプロセッシングサービスプロバイダーに資金を預金してください。

Visaクレジットカードやデビットカードを利用し、取引口座に預け入れを行いましょう。 ';
//withdraw/debit-credit-cards
$lang['s_109-a'] = 'Finance - Withdrawal Option - Skrill  | ForexMart';
$lang['s_109-b'] = 'Skrill (Moneybookers) では、登録メールアドレスでSkrillウォレットから資金を取引口座に預け入 れしたり、Skrillウォレットに資金を引き出すことができます。';
//withdraw/skrill
$lang['s_110-a'] = 'Finance - Withdrawal Option - Neteller   | ForexMart';
$lang['s_110-b'] = '資金送金サービスを提供する独立企業として、Netellerは迅速で簡単な方法でお客様の取引口座へ預け入
...
$lang['s_112-b'] = 'Paypalは、簡単で安全な資金送金・オンライン決済手段です。';
//withdraw/paypal
